...
import { updateFamily } from "@/lib/action/family.action";
  ...
  return (
    <div className="flex justify-center mt-14" >
      <div>
        ...
        <h1 className=" mb-7 font-cairo font-bold text-sky-800 text-2xl text-center">تحديث بيانات العائلة</h1>

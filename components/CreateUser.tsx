...
const formSchema = z.object({
  ...
  wifeone: z.string().optional(),
  wifetwo: z.string().optional(),
  wifethree: z.string().optional(),
  wifefure: z.string().optional(),
...
<FormField
      ...
      <button className=" border-b-2 border-yellow-500 rounded-tr-xl rounded-bl-xl w-36 h-11 text-white bg-sky-800 hover:bg-sky-700 mr-6 m-3 ">
        <Link href="/userview">عودة</Link>
      </button>
    </div>
  );
};
